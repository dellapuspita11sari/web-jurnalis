...
<body>
  ...
  <body>
    ...
    <div class="text-center widget Blog" data-version="2" text="center" id="Blog1">
      <div class="latestposts-title">
        <h7>Postingan Terbaru</h7>
      </div>
    </div>
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 posts-list">
          ...
          <!-- ======= Hero Section ======= -->
          <section id="hero" class="hero p-3 mb-2 bg-transparent">
            <div class="container position-relative">
              <div class="row gy-5" data-aos="fade-in">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
                  <h2 class="text-dark">Welcome to <span>Ruang Update</span></h2>
                  <p class="text-dark">UKM Jurnalistik Politeknik Balekambang Jepara
                  </p>
                  <div class="d-flex justify-content-center justify-content-lg-start">
                    <a href="#about" class="btn-get-started">Get Started</a>
                    <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch
                        Video</span></a>
                  </div>
                </div>
